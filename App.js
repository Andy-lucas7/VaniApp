...
import { View, Text, TextInput, FlatList, StyleSheet, Alert, TouchableOpacity, ScrollView, SafeAreaView } from 'react-native';
...
export default function App() {
  ...
  const renderSaleItem = ({ item }) => (
    <View style={styles.saleCard}>
      <Ionicons name="receipt" size={24} color="#4CAF50" style={styles.saleIcon} />
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Vanidog Inventory</Text>
      </View>
